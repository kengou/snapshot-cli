...
```bash
helm install snapshot-cli oci://ghcr.io/kengou/snapshot-cli/charts/snapshot-cli --version 0.1.1
```
...
```bash
helm install snapshot-cli oci://ghcr.io/kengou/snapshot-cli/charts/snapshot-cli --version 0.1.1 --set openstack.enabled=true,openstack.OS_AUTH_URL=https://my-openstack.com
```
